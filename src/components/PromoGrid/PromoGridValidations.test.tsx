...
describe('PromoGridValidations', () => {
  ...
  test('fetches data from useLocation error', async () => {
    (useLocation as jest.Mock).mockReturnValue({ state: { responseData: null } });
    await act(async () =>
      render(
        <Provider store={store}>
          <BrowserRouter>
  ...
  test('handle validate calls promoGridValidate without error and warning', async () => {
    ...
    (promoGridValidate as jest.Mock).mockResolvedValue(mockUpdatedState);
    await act(async () =>
      render(
        <Provider store={store}>
          <BrowserRouter>
  ...
  test('handle validate calls promoGridValidate catch error', async () => {
    ...
    (promoGridValidate as jest.Mock).mockRejectedValue({ response: { data: mockResponseData } });
    await act(async () =>
      render(
        <Provider store={store}>
          <BrowserRouter>
  ...
  test('handle submit calls promoGridSubmit', async () => {
    ...
    (promoGridSubmit as jest.Mock).mockResolvedValue(promoHeader);
  ...
  test('handle submit calls promoGridSubmit catch error', async () => {
    ...
    (promoGridValidate as jest.Mock).mockResolvedValue(mockUpdatedState);
    (promoGridSubmit as jest.Mock).mockRejectedValue({});
    await act(async () =>
      render(
        <Provider store={store}>
          <BrowserRouter>
  ...
  test('test promo grid warning messages for customer item number and proxy item number', async () => {
    ...
    (promoGridValidate as jest.Mock).mockResolvedValue(mockResponseData);
    await act(async () =>
      render(
        <Provider store={store}>
          <BrowserRouter>
