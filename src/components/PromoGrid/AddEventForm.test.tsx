...
describe('Add Event Form Component', () => {
    ...
    await act(async () => {
      render(
        <Provider store={store}>
          <AddEventForm customerId="1" handleClose={() => {}} />
        </Provider>
      );
    });
  ...
  test('should handle form submission correctly', async () => {
    (addNewRowData as jest.Mock).mockResolvedValueOnce({});
    const handleClose = jest.fn();
    await act(async () => {
      render(
        <Provider store={store}>
          <AddEventForm customerId="1" handleClose={handleClose} />
        </Provider>
      );
    });
    await act(async () => {
  ...
  test('should handle form errors correctly', async () => {
    ...
    (addNewRowData as jest.Mock).mockRejectedValueOnce(errorResponse);
    const handleClose = jest.fn();
    await act(async () => {
      render(
        <Provider store={store}>
  ...
  test('should handle form Warnings correctly', async () => {
    ...
    (addNewRowData as jest.Mock).mockRejectedValueOnce(warningResponse);
    const handleClose = jest.fn();
    await act(async () => {
      render(
        <Provider store={store}>
