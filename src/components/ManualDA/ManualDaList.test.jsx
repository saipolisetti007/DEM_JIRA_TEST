...
import { maualDaList, downloadBlankExcel } from '../../api/manualDaApi';
import { downloadDataExcel } from '../../api/promoGridApi';
...
describe('ManualDaList Component', () => {
  ...
  test('renders without crashing', async () => {
    maualDaList.mockResolvedValue(mockdata);
    render(
  ...
  test('renders with manual da list api error', async () => {
    maualDaList.mockRejectedValue(new Error('API Error'));
    render(
      <ThemeProvider theme={customTheme}>
        <Provider store={store}>
          <BrowserRouter>
