...
describe('promoGridApi', () => {
  ...
  test('adds new row data', async () => {
    ...
    (performApiRequest as jest.Mock).mockResolvedValueOnce(rowData);
  ...
  test('downloads Data Excel', async () => {
    ...
    (performApiRequest as jest.Mock).mockResolvedValueOnce(response);
  ...
  test('Upload Excel file', async () => {
    ...
    (performApiRequest as jest.Mock).mockResolvedValueOnce(mockResponse);
  ...
  test('get promo Grid Filters', async () => {
    ...
    (performApiRequest as jest.Mock).mockResolvedValueOnce(mockFilters);
  ...
  test('get promoGridColumnSettings ', async () => {
    ...
    (performApiRequest as jest.Mock).mockResolvedValueOnce(mockSettings);
