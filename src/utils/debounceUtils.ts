...
const createDebouncedFetchFilters = (
  fetchFiltersFn: Function, // function to fetch filters
  setFilterOptions: Function, // function to set the filter options
  setIsSnackOpen: Function, // function to set the snack bar open state
  setSnackBar: Function, // function to set the snack bar message and severity
  excludeKeys: string[] = [] // keys to exclude from the fetch filters request
) =>
