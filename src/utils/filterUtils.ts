import { SelectedFiltersType } from '../components/CPFForecast/CPFForecastMain';
import { FilterOptionsType } from '../components/PromoGrid/PromoGridData';

// Function to reduce filters by removing 'All' values and converting single values to arrays
export const reduceFilters = (
  filters: SelectedFiltersType | FilterOptionsType
): SelectedFiltersType => {
...
export const mapFilterParams = (filterParams: SelectedFiltersType): SelectedFiltersType => {
  return {
